...
namespace Sulvic.VoLov.Controls{
	...
	public partial class @KaminagaControls: IInputActionCollection2, IDisposable{
		...
		private IKeyMouseActions m_KeyMouseActionsCallbackInterface;
		...
		public struct KeyMouseActions{
			...
			public void SetCallbacks(IKeyMouseActions instance){
				if(m_Wrapper.m_KeyMouseActionsCallbackInterface != null){
					@WalkForward.started -= m_Wrapper.m_KeyMouseActionsCallbackInterface.OnWalkForward;
					@WalkForward.performed -= m_Wrapper.m_KeyMouseActionsCallbackInterface.OnWalkForward;
					@WalkForward.canceled -= m_Wrapper.m_KeyMouseActionsCallbackInterface.OnWalkForward;
					@WalkBackward.started -= m_Wrapper.m_KeyMouseActionsCallbackInterface.OnWalkBackward;
					@WalkBackward.performed -= m_Wrapper.m_KeyMouseActionsCallbackInterface.OnWalkBackward;
					@WalkBackward.canceled -= m_Wrapper.m_KeyMouseActionsCallbackInterface.OnWalkBackward;
					@Sprint.started -= m_Wrapper.m_KeyMouseActionsCallbackInterface.OnSprint;
					@Sprint.performed -= m_Wrapper.m_KeyMouseActionsCallbackInterface.OnSprint;
					@Sprint.canceled -= m_Wrapper.m_KeyMouseActionsCallbackInterface.OnSprint;
				}
				m_Wrapper.m_KeyMouseActionsCallbackInterface = instance;
				if(instance != null){
		...
		public struct GamepadActions{
			...
			public void SetCallbacks(IGamepadActions instance){
				if(m_Wrapper.m_GamepadActionsCallbackInterface != null){
					@WalkForward.started -= m_Wrapper.m_GamepadActionsCallbackInterface.OnWalkForward;
					@WalkForward.performed -= m_Wrapper.m_GamepadActionsCallbackInterface.OnWalkForward;
					@WalkForward.canceled -= m_Wrapper.m_GamepadActionsCallbackInterface.OnWalkForward;
					@WalkBackward.started -= m_Wrapper.m_GamepadActionsCallbackInterface.OnWalkBackward;
					@WalkBackward.performed -= m_Wrapper.m_GamepadActionsCallbackInterface.OnWalkBackward;
					@WalkBackward.canceled -= m_Wrapper.m_GamepadActionsCallbackInterface.OnWalkBackward;
